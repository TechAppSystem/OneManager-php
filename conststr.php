...
$constStr = [
    ...
    'EnvironmentsDescription' => [
	 'pt-br' => [
            'admin' => 'A senha do administrador, o botão Login não aparecerá quando estiver vazio',
            'adminloginpage' => 'se definido, o botão Login não será exibido e a página de login não será mais \'?admin\', isto é \'?{este valor}\'.',
            ...
            'disktag' => 'Uma tag usada na configuração e url da loja.',
            'disableShowThumb' => 'Adicione 0 ou 1. Se for 1, o botão mostrar miniatura não será exibido',
            'disableChangeTheme' => 'Adicione 0 ou 1. Se colocar 1 o seletor de temas não será exibido ao usuário, exibirá apenas para o administrador',
            'downloadencrypt' => 'Adicione 0 ou 1. Se colocar 1, os arquivos na pasta criptografada podem ser baixados sem senha',
            'background' => 'Adicione aqui a URL do Wallpaper que em navegadores de computadores ou outros dispositivos.',
            'backgroundm' => 'Adicione aqui a URL do Wallpaper que aparecerá em celulares.',
            ...
            'public_path' => 'Esta pasta do Onedrive será exibida quando através do URL longo da API Gateway; público mostra arquivos menos que privados.',
            'sitename' => 'Nome do seu sistema',
    ...
    'SetSecretsFirst' => [
	'pt-br' => 'Defina a API no Config primeiro! ou reinstale.',    
    ...
    'RefreshtoLogin' => [
	'pt-br' => '<font color="red">Atualizar</font> and login.',    
    ...
    'CopyAllDownloadUrl' => [
	'pt-br' => 'COPIAR TODOS OS LINKS DE DOWNLOAD',    
    ...
    'WaitJumpIndex' => [
	'pt-br' => 'Aguarde 5s para ir para a página inicial',    
